...
//! the device; package downloads and installation require an explicit click.
...
/// Public alias for the internal Win32 wide-string helper.
#[allow(dead_code)]
pub fn wstr_public(text: &str) -> Vec<u16> {
    wstr(text)
}
...
fn request(
    ...
    unsafe {
        ...
        let _connection_guard = SessionGuard(connection);
        ...
        let _request_guard = SessionGuard(request);
